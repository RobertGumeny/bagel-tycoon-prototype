...
export const BASE_COSTS = {
  ...
  manager: 125, // One-time hire per station
  registerManager: 150, // One-time automation
  secondRegister: 250, // One-time additional register
} as const;
...
export const PRESTIGE = {
  ...
  incomeBonus: 0.1, // +10% income per prestige level
} as const;
